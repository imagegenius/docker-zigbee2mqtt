pipeline {
  ...
  environment {
    ...
    JSON_URL = 'https://api.github.com/repos/koenkk/zigbee2mqtt/releases/latest'
    JSON_PATH = '.tag_name'
    BUILD_VERSION_ARG = 'ZIGBEE2MQTT_VERSION'
    USER = 'hydazz'
    REPO = 'docker-zigbee2mqtt'
    CONTAINER_NAME = 'zigbee2mqtt'
    DOCKERHUB_IMAGE = 'hydaz/zigbee2mqtt'
    DEV_DOCKERHUB_IMAGE = 'dev/zigbee2mqtt'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/hydazz/docker-zigbee2mqtt/packages\" \
          --label \"org.opencontainers.image.source=https://github.com/hydazz/docker-zigbee2mqtt\" \
